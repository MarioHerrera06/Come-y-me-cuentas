...
<html>
    ...
    <body>
        ...
        <section>
            <h1 id="titulosRestaurantes" style="color: grey;  border-bottom: double; border-color: orange; border-left: double; padding-left: 4%;">Restaurantes americanos </h1>
            <% Conexion conec = new Conexion();
                ArrayList<Restaurante> listaRestaurantes = conec.mostrarRestauranteRandom("Americana");
